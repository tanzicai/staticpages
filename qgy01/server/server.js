...
router2.get("/api/download/process-card", (req, res) => {
  console.log("\u6536\u5230\u5DE5\u827A\u5361\u4E0B\u8F7D\u8BF7\u6C42");
  const filePath = "D:\\cnbuilder\\V3\\V3\\src\\img\\\u673A\u5668\u4EBA\u5361\u722A\u5DE5\u5E8F\u5361.docx";
  console.log("\u5C1D\u8BD5\u4E0B\u8F7D\u6587\u4EF6:", filePath);
  console.log("\u6587\u4EF6\u662F\u5426\u5B58\u5728:", import_fs.default.existsSync(filePath));
  if (import_fs.default.existsSync(filePath)) {
    res.download(filePath, "\u673A\u5668\u4EBA\u5361\u722A\u5DE5\u5E8F\u5361.docx", (err) => {
      if (err) {
    ...
    console.log("\u5DE5\u827A\u5361\u6587\u4EF6\u4E0D\u5B58\u5728");
    res.status(404).json({ error: "\u5DE5\u827A\u5361\u6587\u4EF6\u4E0D\u5B58\u5728" });
  }
});
router2.post("/api/save/bearing-process-card", (req, res) => {
  console.log("\u6536\u5230\u4FDD\u5B58\u8F74\u627F\u6746\u5DE5\u5E8F\u5361\u8BF7\u6C42");
  const { content } = req.body;
  if (!content) {
    return res.status(400).json({ error: "\u7F3A\u5C11\u5185\u5BB9\u6570\u636E" });
  }
  const targetDir = "D:\\cnbuilder\\V3\\V3\\src\\img";
  const filePath = import_path.default.join(targetDir, "\u8F74\u627F\u6746\u52A0\u5DE5\u5DE5\u5E8F\u5361.docx");
...
router2.get("/api/download/bearing-process-card", (req, res) => {
  console.log("\u6536\u5230\u4E0B\u8F7D\u8F74\u627F\u6746\u5DE5\u5E8F\u5361\u8BF7\u6C42");
  const filePath = "D:\\cnbuilder\\V3\\V3\\src\\img\\\u8F74\u627F\u6746\u52A0\u5DE5\u5DE5\u5E8F\u5361.docx";
  console.log("\u5C1D\u8BD5\u4E0B\u8F7D\u6587\u4EF6:", filePath);
  console.log("\u6587\u4EF6\u662F\u5426\u5B58\u5728:", import_fs.default.existsSync(filePath));
  if (import_fs.default.existsSync(filePath)) {
    res.download(filePath, "\u8F74\u627F\u6746\u52A0\u5DE5\u5DE5\u5E8F\u5361.docx", (err) => {
      if (err) {
        console.error("\u6587\u4EF6\u4E0B\u8F7D\u5931\u8D25:", err);
        res.status(500).json({ error: "\u6587\u4EF6\u4E0B\u8F7D\u5931\u8D25" });
      }
    ...
    console.log("\u8F74\u627F\u6746\u5DE5\u5E8F\u5361\u6587\u4EF6\u4E0D\u5B58\u5728");
    res.status(404).json({ error: "\u8F74\u627F\u6746\u5DE5\u5E8F\u5361\u6587\u4EF6\u4E0D\u5B58\u5728" });
  }
});
